...
part 'geography_workbanch_model.g.dart';

@JsonSerializable()
class GeographyWorkbanchGet {
  String? id;
  String? agencyId;
  String? agencyCode;
  String? agencyName;
  ...
  factory GeographyWorkbanchGet.fromJson(Map<String, dynamic> json) =>
      _$GeographyWorkbanchGetFromJson(json);
  Map<String, dynamic> toJson() => _$GeographyWorkbanchGetToJson(this);
}
