...
LocationModel _$LocationModelFromJson(Map<String, dynamic> json) =>
    LocationModel(
      ...
      createdByCompanyCode: json['createdByCompanyCode'] as String?,
      createdByCompanyName: json['createdByCompanyName'] as String?,
      createdAt: json['createdAt'] as num?,
      updatedByCode: json['updatedByCode'] as String?,
      updatedByName: json['updatedByName'] as String?,
      updatedByUsername: json['updatedByUsername'] as String?,
      updatedByEmail: json['updatedByEmail'] as String?,
      updatedByCompanyCode: json['updatedByCompanyCode'] as String?,
      updatedByCompanyName: json['updatedByCompanyName'] as String?,
