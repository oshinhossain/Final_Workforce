...
part 'my_approval_dashboard_transport_order.g.dart';

@JsonSerializable()
class MyApprovalDashboardTransportOrder {
  String? id;
  String? countryCode;
  String? countryName;
  ...
  List<TransportOrderLines>? transportOrderLines;

  // Extra
  bool? isExpanded;
  bool? singleReceivingPerson;
  bool? singleGoodsInspectorAtTheDropLocation;
  bool? singleDropLocation;
  bool? prescribeTravelPath;

  MyApprovalDashboardTransportOrder({
    this.id,
    this.countryCode,
    this.countryName,
    ...
    // Extra
    this.isExpanded,
    this.singleReceivingPerson,
    this.singleGoodsInspectorAtTheDropLocation,
    this.singleDropLocation,
    this.prescribeTravelPath,
  });

  factory MyApprovalDashboardTransportOrder.fromJson(
          Map<String, dynamic> json) =>
      _$MyApprovalDashboardTransportOrderFromJson(json);
  Map<String, dynamic> toJson() =>
      _$MyApprovalDashboardTransportOrderToJson(this);
}
