...
part of 'my_approval_dashboard_transport_order.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MyApprovalDashboardTransportOrder _$MyApprovalDashboardTransportOrderFromJson(
    ...
    MyApprovalDashboardTransportOrder(
      ...
      transporterUsername: json['transporterUsername'] as String?,
      transporterEmail: json['transporterEmail'] as String?,
      transporterMobile: json['transporterMobile'] as String?,
      receiverPartyType: json['receiverPartyType'] as String?,
      ...
      orderApproverCount: json['orderApproverCount'] as int?,
      ...
      transportOrderLines: (json['transportOrderLines'] as List<dynamic>?)
          ?.map((e) => TransportOrderLines.fromJson(e as Map<String, dynamic>))
          .toList(),
      isExpanded: json['isExpanded'] as bool?,
      singleReceivingPerson: json['singleReceivingPerson'] as bool?,
      singleGoodsInspectorAtTheDropLocation:
          json['singleGoodsInspectorAtTheDropLocation'] as bool?,
      singleDropLocation: json['singleDropLocation'] as bool?,
      prescribeTravelPath: json['prescribeTravelPath'] as bool?,
    );

Map<String, dynamic> _$MyApprovalDashboardTransportOrderToJson(
        MyApprovalDashboardTransportOrder instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'transportOrderLines': instance.transportOrderLines,
      'isExpanded': instance.isExpanded,
      'singleReceivingPerson': instance.singleReceivingPerson,
      'singleGoodsInspectorAtTheDropLocation':
          instance.singleGoodsInspectorAtTheDropLocation,
      'singleDropLocation': instance.singleDropLocation,
      'prescribeTravelPath': instance.prescribeTravelPath,
    };
