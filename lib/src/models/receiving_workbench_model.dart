...
part 'receiving_workbench_model.g.dart';

@JsonSerializable()
class ReceivingWorkbenchModel {
  String? id;
  ...
  factory ReceivingWorkbenchModel.fromJson(Map<String, dynamic> json) =>
      _$ReceivingWorkbenchModelFromJson(json);
  Map<String, dynamic> toJson() => _$ReceivingWorkbenchModelToJson(this);
}
