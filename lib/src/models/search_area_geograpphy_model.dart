...
part 'search_area_geograpphy_model.g.dart';

@JsonSerializable()
class SearchAreaGeograpphy {
  String? id;
  String? apiKey;
  String? areaId;
  String? areaFullCode;
  ...
  factory SearchAreaGeograpphy.fromJson(Map<String, dynamic> json) =>
      _$SearchAreaGeograpphyFromJson(json);
  Map<String, dynamic> toJson() => _$SearchAreaGeograpphyToJson(this);
}
