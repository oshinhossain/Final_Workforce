...
class MyGeographyForEquipmentInspector extends StatelessWidget with Base {
  ...
  Widget build(BuildContext context) {
    ...
    geographyWorkBanchC.geographyWorkbanchEquipmentInspectorGetApi();
    return WillPopScope(
      onWillPop: () {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Center(
                        child: KText(
                          text: 'My Geography for Equipment Inspection',
                          fontSize: 15,
                                ...
                                return DropdownMenuItem(
                                  onTap: () async {
                                    ...
                                    await geographyWorkBanchC
                                        .geographyWorkbanchEquipmentInspectorGetApi();
                                ...
                                children: [
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    child: OutlinedButton(
                                                      onPressed: () {
                                                        ...
                                                        geographyWorkBanchC
                                                            .geographyProjectWorkbanchStatusUpdateEquipmentInspector(
                                                                item: item,
                                                                status:
                                                                    'Started',
                                                                statuscode:
                                                            ...
                                                            child:
                                                                OutlinedButton(
                                                                    onPressed:
                                                                        () {
                                                                      // Add your onPressed code here!
                                                                      geographyWorkBanchC.geographyProjectWorkbanchStatusUpdateEquipmentInspector(
                                                                          item:
                                                                              item,
                                                                          status:
                                                                              'Restarted',
                                                                    ...
                                                                    children: [
                                                                      SizedBox(
                                                                        ...
                                                                        child: OutlinedButton(
                                                                            onPressed: () {
                                                                              // Add your onPressed code here!
                                                                              geographyWorkBanchC.geographyProjectWorkbanchStatusUpdateEquipmentInspector(item: item, status: 'Postponed', statuscode: '02');
                                                                            },
                                                                            child: KText(
                                                                              text: 'Postpone',
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child: OutlinedButton(
                                                                            onPressed: () {
                                                                              // Add your onPressed code here!
                                                                              geographyWorkBanchC.geographyProjectWorkbanchStatusUpdateEquipmentInspector(item: item, status: 'Completed', statuscode: '05');
                                                                            },
                                                                            child: KText(
                                                                              text: 'Complete',
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child: OutlinedButton(
                                                                            onPressed: () {
                                                                              // Add your onPressed code here!
                                                                              geographyWorkBanchC.geographyProjectWorkbanchStatusUpdateEquipmentInspector(item: item, status: 'Aborted', statuscode: '03');
                                                                            },
                                                                            child: KText(
                                                                              text: 'Abort',
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      width: 90,
                                      decoration: BoxDecoration(
                                        color: item.equipmentInspectorStatus ==
                                                'Restarted'
                                            ? hexToColor('#FFF3E1')
                                            : item.equipmentInspectorStatus ==
                                                    'Aborted'
                                      ...
                                      child: Center(
                                        child: KText(
                                          text: item.equipmentInspectorStatus,
                                          fontSize: 11,
                                          color: item.equipmentInspectorStatus ==
                                                  'Restarted'
                                              ? hexToColor('#FFA133')
