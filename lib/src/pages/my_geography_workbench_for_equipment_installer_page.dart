...
class MyGeographyForEquipmentInstaller extends StatelessWidget with Base {
  ...
  Widget build(BuildContext context) {
    ...
    geographyWorkBanchC.geographyWorkbanchEquipmentInstallerGetApi();
    return WillPopScope(
      onWillPop: () {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Center(
                        child: KText(
                          text: 'My Geography for Equipment Installation',
                          fontSize: 15,
                                ...
                                return DropdownMenuItem(
                                  onTap: () async {
                                    ...
                                    await geographyWorkBanchC
                                        .geographyWorkbanchEquipmentInstallerGetApi();
                              ...
                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: OutlinedButton(
                                                    onPressed: () {
                                                      ...
                                                      geographyWorkBanchC
                                                          .geographyProjectWorkbanchStatusUpdateEquipmentInstaller(
                                                              item: item,
                                                              status: 'Started',
                                                              statuscode: '01');
                                                    },
                                                              ...
                                                              child:
                                                                  OutlinedButton(
                                                                      onPressed:
                                                                          () {
                                                                        // Add your onPressed code here!
                                                                        geographyWorkBanchC.geographyProjectWorkbanchStatusUpdateEquipmentInstaller(
                                                                            item:
                                                                                item,
                                                                            status:
                                                                                'Restarted',
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    width: 90,
                                    decoration: BoxDecoration(
                                      color: item.equipmentInstallerStatus ==
                                              'Restarted'
                                          ? hexToColor('#FFF3E1')
                                          : item.equipmentInstallerStatus ==
                                                  'Aborted'
                                    ...
                                    child: Center(
                                      child: KText(
                                        text: item.equipmentInstallerStatus,
                                        fontSize: 11,
                                        color: item.equipmentInstallerStatus ==
                                                'Restarted'
                                            ? hexToColor('#FFA133')
