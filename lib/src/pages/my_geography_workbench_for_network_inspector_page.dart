...
class MyGeographyForNetworkInspector extends StatelessWidget with Base {
  ...
  Widget build(BuildContext context) {
    ...
    geographyWorkBanchC.geographyWorkbanchNetworkInspectorGetApi();
    return WillPopScope(
      onWillPop: () {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Center(
                        child: KText(
                          text: 'My Geography for Network Inspection',
                          fontSize: 16,
                                ...
                                return DropdownMenuItem(
                                  onTap: () async {
                                    ...
                                    await geographyWorkBanchC
                                        .geographyWorkbanchNetworkInspectorGetApi();
                                ...
                                children: [
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    child: OutlinedButton(
                                                      onPressed: () {
                                                        ...
                                                        geographyWorkBanchC
                                                            .geographyProjectWorkbanchStatusUpdateNetworkInspector(
                                                                item: item,
                                                                status:
                                                                    'Started',
                                                                statuscode:
                                                            ...
                                                            child:
                                                                OutlinedButton(
                                                                    onPressed:
                                                                        () {
                                                                      // Add your onPressed code here!
                                                                      geographyWorkBanchC.geographyProjectWorkbanchStatusUpdateNetworkInspector(
                                                                          item:
                                                                              item,
                                                                          status:
                                                                              'Restarted',
                                                                    ...
                                                                    children: [
                                                                      SizedBox(
                                                                        ...
                                                                        child: OutlinedButton(
                                                                            onPressed: () {
                                                                              // Add your onPressed code here!
                                                                              geographyWorkBanchC.geographyProjectWorkbanchStatusUpdateNetworkInspector(item: item, status: 'Postponed', statuscode: '02');
                                                                            },
                                                                            child: KText(
                                                                              text: 'Postpone',
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child: OutlinedButton(
                                                                            onPressed: () {
                                                                              // Add your onPressed code here!
                                                                              geographyWorkBanchC.geographyProjectWorkbanchStatusUpdateNetworkInspector(item: item, status: 'Completed', statuscode: '05');
                                                                            },
                                                                            child: KText(
                                                                              text: 'Complete',
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child: OutlinedButton(
                                                                            onPressed: () {
                                                                              // Add your onPressed code here!
                                                                              geographyWorkBanchC.geographyProjectWorkbanchStatusUpdateNetworkInspector(item: item, status: 'Aborted', statuscode: '03');
                                                                            },
                                                                            child: KText(
                                                                              text: 'Abort',
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      width: 90,
                                      decoration: BoxDecoration(
                                        color: item.networkInspectorStatus ==
                                                'Restarted'
                                            ? hexToColor('#FFF3E1')
                                            : item.networkInspectorStatus ==
                                                    'Aborted'
                                      ...
                                      child: Center(
                                        child: KText(
                                          text: item.networkInspectorStatus,
                                          fontSize: 11,
                                          color: item.networkInspectorStatus ==
                                                  'Restarted'
                                              ? hexToColor('#FFA133')
