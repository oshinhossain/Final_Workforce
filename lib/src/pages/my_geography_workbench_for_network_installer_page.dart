...
class MyGeographyForNetworkInstaller extends StatelessWidget with Base {
  ...
  Widget build(BuildContext context) {
    ...
    geographyWorkBanchC.geographyWorkbanchNetworkInstallerGetApi();
    return WillPopScope(
      onWillPop: () {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Center(
                        child: KText(
                          text: 'My Geography for Network Installation',
                          fontSize: 16,
                                ...
                                return DropdownMenuItem(
                                  onTap: () async {
                                    ...
                                    await geographyWorkBanchC
                                        .geographyWorkbanchNetworkInstallerGetApi();
                              ...
                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: OutlinedButton(
                                                    onPressed: () {
                                                      ...
                                                      geographyWorkBanchC
                                                          .geographyProjectWorkbanchStatusUpdateNetworkInstaller(
                                                              item: item,
                                                              status: 'Started',
                                                              statuscode: '01');
                                                    },
                                                              ...
                                                              child:
                                                                  OutlinedButton(
                                                                      onPressed:
                                                                          () {
                                                                        // Add your onPressed code here!
                                                                        geographyWorkBanchC.geographyProjectWorkbanchStatusUpdateNetworkInstaller(
                                                                            item:
                                                                                item,
                                                                            status:
                                                                                'Restarted',
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    width: 90,
                                    decoration: BoxDecoration(
                                      color: item.networkInstallerStatus ==
                                              'Restarted'
                                          ? hexToColor('#FFF3E1')
                                          : item.networkInstallerStatus ==
                                                  'Aborted'
                                    ...
                                    child: Center(
                                      child: KText(
                                        text: item.networkInstallerStatus,
                                        fontSize: 11,
                                        color: item.networkInstallerStatus ==
                                                'Restarted'
                                            ? hexToColor('#FFA133')
