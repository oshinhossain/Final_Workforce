...
class TransportationDashboardReceiverPage extends StatelessWidget with Base {
  @override
                          ...
                          return Obx(
                            () => GestureDetector(
                              ...
                              child: Container(
                                ...
                                height: uiC.isExpanded.value ? 580 : 580,
                                        ...
                                        ? Column(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: KText(
                                                    text:
                                                        '2 Poles got damaged at the loading time.',
                                                    color: AppTheme.nTextC),
                                              ),
                                              Divider(
                                                color: AppTheme.nBorderC1,
                                              ...
                                              Padding(
                                                ...
                                                child: KText(
                                                  text:
                                                      'Remarks from Warehouses Manager',
                                                  color: AppTheme.nTextLightC,
                                                ),
                                              ),
                                              Padding(
                                                ...
                                                child: KText(
                                                    text:
                                                        '2 Poles got damaged at the unloading time.',
                                                    color: AppTheme.nTextC),
                                              ),
                                              Divider(
                                                color: AppTheme.nBorderC1,
